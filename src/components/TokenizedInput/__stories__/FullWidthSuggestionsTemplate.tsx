...
export const FullWidthSuggestionsTokenizedInput = (
...
export const FullWidthSuggestionsTemplate: StoryFn<TokenizedComponentType<TokenValue>> = (args) => {
    return <FullWidthSuggestionsTokenizedInput {...args} />;
};
