...
export const DefaultTokenizedInput = (
...
export const DefaultTemplate: StoryFn<TokenizedComponentType<TokenValue>> = (args) => {
    return <DefaultTokenizedInput {...args} autoFocus />;
};
