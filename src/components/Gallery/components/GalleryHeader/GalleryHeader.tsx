        ...
        return (
            <React.Fragment>
                <Flex
                    ...
                    className={cnGalleryHeader('mobile-header', {hidden, interactive})}
                >
                    <Button size="xl" view="flat" onClick={onBackClick} aria-label={i18n('back')}>
                        <Icon size={20} data={ChevronLeft} />
                    </Button>

                    <Text
                        color={interactive ? 'primary' : 'inverted-primary'}
                        variant="subheader-2"
                    >
                ...
                <Flex
                    ...
                    className={cnGalleryHeader('mobile-footer', {hidden, interactive})}
                >
                    {itemName}
                </Flex>
                {mobileActionsOpen && (
